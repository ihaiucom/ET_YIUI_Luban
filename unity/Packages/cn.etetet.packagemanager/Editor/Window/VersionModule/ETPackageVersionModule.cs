...
namespace ET.PackageManager.Editor
{
    ...
    public partial class ETPackageVersionModule : BasePackageToolModule
    {
        ...
        private void UpdatePackagesInfo(bool close = true)
        {
        ...
        private void ChangePackageInfo(PackageVersionData packageInfoData)
        {
            ...
            try
            {
                ...
                json["dependencies"] = NewDependencies(packageInfoData);
                 ...
                 File.WriteAllText(packagePath, json.ToString(), System.Text.Encoding.UTF8);
