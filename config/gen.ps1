...
# 客户端 Client
& $DotNet  $GEN_CLIENT    --customTemplateDir $CUSTOM    -t client    -c cs-bin    -d bin    -d json    --conf $CONFIG_ROOT/luban.conf    -x outputCodeDir=$WORKSPACEGEN/CodeMode/Model/Client/LubanGen/Config     -x bin.outputDataDir=$WORKSPACEGEN/Assets/LubanGen/Config/Binary/Client    -x json.outputDataDir=$WORKSPACEGEN/Assets/LubanGen/Config/Json/Client
Write-Host "==================== Client 客户端 完成 ===================="

# 服务器 Server
& $DotNet   $GEN_CLIENT    --customTemplateDir $CUSTOM    -t server    -c cs-bin    -d bin    -d json    --conf $CONFIG_ROOT/luban.conf    -x outputCodeDir=$WORKSPACEGEN/CodeMode/Model/Server/LubanGen/Config     -x bin.outputDataDir=$WORKSPACEGEN/Assets/LubanGen/Config/Binary/Server    -x json.outputDataDir=$WORKSPACEGEN/Assets/LubanGen/Config/Json/Server
Write-Host "==================== Server 服务器 完成 ===================="


# 所有 ClientServer
& $DotNet   $GEN_CLIENT    --customTemplateDir $CUSTOM    -t all    -c cs-bin    -d bin    -d json    --conf $CONFIG_ROOT/luban.conf    -x outputCodeDir=$WORKSPACEGEN/CodeMode/Model/ClientServer/LubanGen/Config     -x bin.outputDataDir=$WORKSPACEGEN/Assets/LubanGen/Config/Binary/ClientServer    -x json.outputDataDir=$WORKSPACEGEN/Assets/LubanGen/Config/Json/ClientServer
...
& $DotNet  $GEN_CLIENT    --customTemplateDir $CUSTOM    -t all    -c cs-bin    --conf $START_CONFIG_ROOT/Localhost/Base/luban.conf    -x outputCodeDir=$WORKSPACEGEN/CodeMode/Model/ClientServer/LubanGen/StartConfig 
