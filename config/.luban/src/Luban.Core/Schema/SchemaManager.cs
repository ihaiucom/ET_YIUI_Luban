...
public class SchemaManager
{
    ...
    {
        public string Type { get; init; } // table, bean, enum, ""

        public string ExtName { get; init; } // "xlsx", "xls", "xlsm", "csv", "xml"

        public int Priority { get; init; }

        public Func<ISchemaLoader> Creator { get; init; } // ExcelSchemaLoader , XmlSchemaLoader
    }

    private readonly Dictionary<(string, string), LoaderInfo> _schemaLoaders = new(); // (LoaderInfo.ExtName, LoaderInfo.Type) = LoaderInfo
